...
(function ($, undefined) {
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            ...
            // Thêm sự kiện click vào phần tử <a>
            container.find('a.select2-choice').on('click', function () {
                // Xử lý sự kiện click tại đây
                // Ví dụ: alert("Bạn đã nhấp vào phần tử <a>");
            });
        ...
        onSelect: function (data, options) {
            ...
            console.log(data);
            const scope = angular.element(document.querySelector('[ng-controller="ChungChi-ctrl"]')).scope();
            scope.$apply(function () {
                scope.loadDocuments(data);
            });
        },
